...
the declared decimal precision. An empty, mismatched, non-finite or
non-monotonic series, nonpositive initial balance, non-integral count, or
declared mismatch quarantines the report.
