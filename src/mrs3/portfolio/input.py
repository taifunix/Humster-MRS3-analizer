        ...
        with duckdb.connect(str(path), read_only=True) as connection:
            ...
            for key in finalist_keys:
                ...
                result_row = {
                    ...
                    "close_ma_len": _source_integer(source.get("close_ma_len"), "close_ma_len"),
                    "order_count": expected_order_count,
                    "analysis_run_id": _source_text(source.get("analysis_run_id"), "analysis_run_id"),
                    "candidate_identity": _source_text(source.get("candidate_identity"), "candidate_identity"),
