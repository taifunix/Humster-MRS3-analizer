...
Будущий портфельный контур сохранён как [историческая source-спецификация v0.4](docs/archive/sources/MRS3_Portfolio_Selector_v0_4.md). Он не становится active feature, пока не появятся требуемые временные ряды MRS3 и отдельная утверждённая спецификация.
