...
| Proposed / design only | [Performance v2 equity quality](docs/specs/2026-09-25-performance-v2-equity-quality.md), [implementation plan](docs/superpowers/plans/2026-09-25-performance-v2-equity-quality.md) | independent filter #2 and optional equity Top N; 7/14/28d, short corrections demote only selected equity ranking while H grows (robust unchanged), shared fast cache, four extra XLSX columns | M0 data-coverage/ranking/performance acceptance required; no runtime implementation or predictive claims |
